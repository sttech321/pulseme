                    ...
                    <div class="p-25px">
                        <div class="p-20px bg-white rounded-4px shadow w-full">
                            ...
                            <div class="flex justify-between items-center mb-20px">
                                <div
                                    class="flex justify-start items-center p-10px border border-gray-300 rounded-4px w-300px">
                                ...
                                <div class="filter flex justify-end items-baseline">
                                    <svg class="svg-inline--fa fa-calendar-day" aria-hidden="true" focusable="false"
                                    ...
                                    <button class="btn btn-blue">
                                        <svg class="svg-inline--fa fa-rotate pr-1" aria-hidden="true" focusable="false"

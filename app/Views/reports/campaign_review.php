...
<div class="headerTop">
   <div class="dropMenuWrap flexBetween">
      <div class="pageNameWrap">
         <h3 class="secTitle">Campaign Reviews</h3>
      </div>
      <div class="rightWrap">
            ...
            let html = '<table class="mb-15px">' +
                        '<thead>' +
                            '<tr>' +
                                ...
                                '<th class="text-left px-20px py-10px cursor-pointer">Google Reviews</th>' +
                                '<th class="text-left px-20px py-10px cursor-pointer">Google Rating</th>' +
                            '</tr>' +
                        '</thead>' +
                        '<tbody>';

            ...
            <div class="grid grid-cols-2 grid-flow-row auto-rows-auto gap-20px w-600px">
               ...
               <button id="download-png" class="border-2 rounded-4px p-15px border-blue-500 text-blue-500 flex justify-evenly items-center">
                  ...
                  <svg class="svg-inline--fa fa-download" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="download" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                     <path class="" fill="currentColor" d="M288 32c0-17.7-14.3-32-32-32s-32 14.3-32 32V274.7l-73.4-73.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l128 128c12.5 12.5 32.8 12.5 45.3 0l128-128c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L288 274.7V32zM64 352c-35.3 0-64 28.7-64 64v32c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V416c0-35.3-28.7-64-64-64H346.5l-45.3 45.3c-25 25-65.5 25-90.5 0L165.5 352H64zm368 56a24 24 0 1 1 0 48 24 24 0 1 1 0-48z"></path>
                  </svg>
               </button>
      ...
      <div class="flex flex-col justify-start items-stretch">
         ...
         <div class="row p-10px flex">
            <div class="column w-2/5 flex justify-center items-start">
               <div class="relative">
                  <div class="h-200px w-200px rounded-1/2 mt-2rem bg-center bg-contain bg-no-repeat" style="background-image: url(&quot;https://kiliassets.speetra.com/prod/account_images/15407/contact_card/logo_1713975820.jpg&quot;);"></div>
            ...
            <div class="column w-full">
               ...
               <div class="info-field flex flex-col justify-start items-start mb-20px">
                  ...
                  <div class="w-auto flex flex-col items-stretch">
                     <div class="number-list flex justify-between items-center hover px-20px border hover:border-gray-500 p-10px my-10px rounded-4px">
                        ...
                        <button id="delete-phone-number-button" class="text-red-500"> Delete </button>
                     </div>
                  </div>
               ...
               <div class="info-field flex flex-col justify-start items-start mb-20px">
                  ...
                  <div class="w-auto flex flex-col items-stretch">
                     <div class="number-list flex justify-between items-center hover px-20px border hover:border-gray-500 p-10px my-10px rounded-4px">
                        ...
                        <button id="delete-email-button" class="text-red-500"> Delete </button>
                     </div>
                  </div>
               ...
               <div class="flex items-center mb-20px">
                  <svg class="svg-inline--fa fa-circle-info text-blue-500 mr-10px text-20px" aria-hidden="true" focusable="false" data-prefix="far" data-icon="circle-info" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                  ...
                  <div class="cursor-pointer">
                     <svg class="svg-inline--fa fa-toggle-on text-blue-500 text-30px" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="toggle-on" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">

...
<div class="sidebarRightContent socialReviewsWrap">
	...
	<div class='sk-ww-google-reviews' data-embed-id='25459433'></div><script src='https://widgets.sociablekit.com/google-reviews/widget.js' async defer></script>
</div>
...
$(document).ready(function() {
    ...
    var reviewsItemDiv = document.querySelector('.google-reviews-item.sk-ww-google-reviews-review-text');

    // HTML content generated by PHP and passed to JavaScript
    var newDivContent = `
    ...
    // Append the generated content to the selected element after the page has loaded
    reviewsItemDiv.insertAdjacentHTML('afterend', newDivContent);
});
</script>

...
<div class="sub-menu-bar pl-25px">
   <div class="flex justify-start items-center border-b border-gray-300"><a href="<?= base_url('/settings/dispatch/campaigns')?>" class="border-b-2 border-blue-500 text-blue-500 router-link-exact-active p-15px" aria-current="page">Campaigns</a><a href="/settings/dispatch/notifications" class="p-15px">Notifications</a><a href="/settings/dispatch/web_widget" class="p-15px">Web
      Widget</a><a href="<?= base_url('/settings/dispatch/review-widget')?>" class="p-15px">Review Widget</a>
   </div>
</div>
<div class="p-25px review-widget">
   <div class="rounded-4px bg-white flex flex-col p-15px">
      <div class="menu w-full flex justify-end p-10px relative">
         <button class="text-gray-500 relative">
            <svg class="svg-inline--fa fa-bars text-xl" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bars" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
      ...
      <div class="flex">
         <div class="w-1/3 p-10px">
            ...
            <button class="btn btn-blue w-auto">
               <svg class="svg-inline--fa fa-floppy-disk" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="floppy-disk" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
         ...
         <div class="w-1/3 p-10px">
            ...
            <p class="mb-10px"> View an example of your review widget. That way you know what it looks like before it goes on your website. Be sure to click <strong>make permanent</strong> for changes to take effect on your website. </p>
            <button class="btn btn-blue w-auto">
               <svg class="svg-inline--fa fa-arrow-up-right-from-square" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="arrow-up-right-from-square" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
         ...
         <div class="w-1/3 p-10px">
            ...
            <p class="mb-10px"> We highly recommend installing the review widget on your website where there is a lot of traffic. We can either give you the code to do it yourself or you can just <a class="text-blue-500" href="javascript:void(null)">give us your webmaster's email so we can send it to them</a>. To get started click the button below. </p>
            <button class="btn btn-orange w-auto mb-10px">
               <svg class="svg-inline--fa fa-code" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="code" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">

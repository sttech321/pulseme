        ...
        <main class="page-content">
            ...
            <div class="flex flex-grow justify-start">
                <div class="w-1/4 max-w-200px flex flex-shrink-0 justify-start items-start flex-col">
                    ...
                    <div class="p-15px">
                        <div class="links flex flex-col border-l border-gray-400"><a href="/settings/general"
                                class="p-15px"><svg class="svg-inline--fa fa-chart-line mr-5px" aria-hidden="true"
                                    focusable="false" data-prefix="fas" data-icon="chart-line" role="img"
                                ...
                                class="border-blue-500 text-blue-500 border-l-2 p-15px"><svg
                                    class="svg-inline--fa fa-arrow-right-arrow-left mr-5px" aria-hidden="true" focusable="false"
                                    data-prefix="fas" data-icon="arrow-right-arrow-left" role="img"
                                ...
                                </svg> Dispatch </a><!----><a href="/settings/contact-card" class="p-15px"><svg
                                    class="svg-inline--fa fa-address-card mr-5px" aria-hidden="true" focusable="false"
                                    data-prefix="fas" data-icon="address-card" role="img" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 576 512">
                                    <path class="" fill="currentColor"
                                        d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zm80 256h64c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16c0-44.2 35.8-80 80-80zm-32-96a64 64 0 1 1 128 0 64 64 0 1 1 -128 0zm256-32H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16z">
                                    </path>
                                </svg> Contact Card </a><!----><a href="/settings/billing" class="p-15px"><svg
                                    class="svg-inline--fa fa-credit-card mr-5px" aria-hidden="true" focusable="false"
                                    data-prefix="fas" data-icon="credit-card" role="img" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 576 512">
                                    <path class="" fill="currentColor"
                ...
                <div class="flex-grow pt-20px">
                    <div class="flex flex-col">
                        <div class="sub-menu-bar pl-25px">
                            <div class="flex justify-start items-center border-b border-gray-300"><a
                                    href="/settings/dispatch/campaigns"
                                    class="border-b-2 border-blue-500 text-blue-500 router-link-exact-active p-15px"
                                    aria-current="page">Campaigns</a><a href="/settings/dispatch/notifications"
                                    class="p-15px">Notifications</a><a href="/settings/dispatch/web-widget" class="p-15px">Web
                        ...
                        <div class="p-25px">
                            <div data-v-24df4780="" class="flex flex-col items-stretch"><!---->
                                <div data-v-24df4780="" class="main p-20px bg-white rounded"><!----><!---->
                                    <div data-v-24df4780=""
                                        class="search flex w-full mb-20px flex justify-between items-center">
                                        <div data-v-24df4780=""
                                            class="search-input border border-gray-400 rounded-4px p-10px flex items-center">
                                            <svg data-v-24df4780="" class="svg-inline--fa fa-magnifying-glass"
                                            ...
                                            </svg><input data-v-24df4780="" class="border-0 ml-10px w-300px outline-none"
                                                type="search" name="search" id="search"
                                                placeholder="Search by name or department">
                                        </div>
                                        <div data-v-24df4780="" class="batch-send">
                                    <!-- <button data-v-24df4780=""
                                        class="btn btn-blue"><svg data-v-24df4780="" class="svg-inline--fa fa-face-grin"
                                            aria-hidden="true" focusable="false" data-prefix="fas" data-icon="face-grin"
                                        ...
                                        <button data-v-24df4780=""
                                        class="btn btn-green ml-2"><svg data-v-24df4780="" class="svg-inline--fa fa-pen"
                                            aria-hidden="true" focusable="false" data-prefix="fas" data-icon="pen"
                                            role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                            <path class="" fill="currentColor"
                                                d="M362.7 19.3L314.3 67.7 444.3 197.7l48.4-48.4c25-25 25-65.5 0-90.5L453.3 19.3c-25-25-65.5-25-90.5 0zm-71 71L58.6 323.5c-10.4 10.4-18 23.3-22.2 37.4L1 481.2C-1.5 489.7 .8 498.8 7 505s15.3 8.5 23.7 6.1l120.3-35.4c14.1-4.2 27-11.8 37.4-22.2L421.7 220.3 291.7 90.3z">
                                            </path>
                                        </svg> Edit Defaults </button></div>
                                    </div>
                                        ...
                                        <table data-v-24df4780="" class="campaigns w-full">
                                            <tr class="flex odd:bg-sky-100 odd:bg-opacity-50 py-15px px-10px">
                                                <td class="employee flex items-center px-10px py-20px flex-shrink-0 w-1/12">
                                                    <div
                                                        class="profile-img w-full h-auto mr-10px flex justify-center items-center">
                                                        <img w-full=""
                                                            src="https://kiliassets.speetra.com/prod/account_images/15407/campaign/1B85A09AA6CF1/1711571243_original.jpg"
                                                            alt="">
                                                    </div>
                                                </td>
                                                ...
                                                <td
                                                    class="recipient-info col-span-6 flex flex-col w-1/2 justify-center items-start px-10px">
                                                ...
                                                <td
                                                    class="flex flex-col justify-center items-end col-span-3 flex-shrink-0 px-10px w-1/4">
                                                    <div class="grid grid-rows-2 grid-flow-col gap-10px"><button
                                                            class="btn btn-blue w-full rounded-2px"
                                                            id="editCampaign-undefined"><svg class="svg-inline--fa fa-face-grin"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="face-grin" role="img"
                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                                <path class="" fill="currentColor"
                                                                    d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM388.1 312.8c12.3-3.8 24.3 6.9 19.3 18.7C382.4 390.6 324.2 432 256.3 432s-126.2-41.4-151.1-100.5c-5-11.8 7-22.5 19.3-18.7c39.7 12.2 84.5 19 131.8 19s92.1-6.8 131.8-19zM144.4 208a32 32 0 1 1 64 0 32 32 0 1 1 -64 0zm192-32a32 32 0 1 1 0 64 32 32 0 1 1 0-64z">
                                                                </path>
                                                            </svg> Edit Campaign </button><button
                                                            class="btn btn-blue w-full rounded-2px" id="showFieldOps-AARON"><svg
                                                                class="svg-inline--fa fa-mobile-screen-button"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                            ...
                                                            </svg> FieldOps App </button><button class="btn btn-red rounded-2px"
                                                            id="showFieldOps-AARON"><svg class="svg-inline--fa fa-trash"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                            ...
                                                            </svg></button><button class="btn btn-blue rounded-2px"
                                                            id="showSample-AARON"><svg class="svg-inline--fa fa-user"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                            ...
                                            <tr class="flex odd:bg-sky-100 odd:bg-opacity-50 py-15px px-10px">
                                                <td class="employee flex items-center px-10px py-20px flex-shrink-0 w-1/12">
                                                    <div
                                                        class="profile-img w-full h-auto mr-10px flex justify-center items-center">
                                                        <img w-full=""
                                                            src="https://kiliassets.speetra.com/prod/account_images/15407/campaign/1D24325B63641/1715613782_original.png"
                                                            alt="">
                                                    </div>
                                                </td>
                                                <td class="employee flex items-center px-10px flex-shrink-0 w-1/6">
                                                ...
                                                <td
                                                    ...
                                                    <div class="grid grid-rows-2 grid-flow-col gap-10px"><button
                                                            ...
                                                            id="showFieldOps-ANGVAZ"><svg class="svg-inline--fa fa-trash"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                                            ...
                                                            id="showSample-ANGVAZ"><svg class="svg-inline--fa fa-user"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                            ...
                                            <tr class="flex odd:bg-sky-100 odd:bg-opacity-50 py-15px px-10px">
                                                <td class="employee flex items-center px-10px py-20px flex-shrink-0 w-1/12">
                                                    <div
                                                        class="profile-img w-full h-auto mr-10px flex justify-center items-center">
                                                        <img w-full=""
                                                            src="https://kiliassets.speetra.com/prod/account_images/15407/campaign/1C14AED7C0389/1711655622_original.jpg"
                                                            alt="">
                                                    </div>
                                                </td>
                                                <td class="employee flex items-center px-10px flex-shrink-0 w-1/6">
                                                ...
                                                <td
                                                    ...
                                                    <div class="grid grid-rows-2 grid-flow-col gap-10px"><button
                                                            ...
                                                            id="showFieldOps-Austin"><svg class="svg-inline--fa fa-trash"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                                            ...
                                                            id="showSample-Austin"><svg class="svg-inline--fa fa-user"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                            ...
                                            <tr class="flex odd:bg-sky-100 odd:bg-opacity-50 py-15px px-10px">
                                                <td class="employee flex items-center px-10px py-20px flex-shrink-0 w-1/12">
                                                    <div
                                                        class="profile-img w-full h-auto mr-10px flex justify-center items-center">
                                                        <img w-full=""
                                                            src="https://kiliassets.speetra.com/prod/account_images/15407/campaign/1D42E41457559/1716232132_original.png"
                                                            alt="">
                                                    </div>
                                                </td>
                                                <td class="employee flex items-center px-10px flex-shrink-0 w-1/6">
                                                ...
                                                <td
                                                    ...
                                                    <div class="grid grid-rows-2 grid-flow-col gap-10px"><button
                                                            ...
                                                            id="showFieldOps-CASEVE"><svg class="svg-inline--fa fa-trash"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                                            ...
                                                            id="showSample-CASEVE"><svg class="svg-inline--fa fa-user"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                            ...
                                            <tr class="flex odd:bg-sky-100 odd:bg-opacity-50 py-15px px-10px">
                                                <td class="employee flex items-center px-10px py-20px flex-shrink-0 w-1/12">
                                                    <div
                                                        class="profile-img w-full h-auto mr-10px flex justify-center items-center">
                                                        <img w-full=""
                                                            src="https://kiliassets.speetra.com/prod/account_images/15407/campaign/1C12F272792B9/1711655796_original.jpg"
                                                            alt="">
                                                    </div>
                                                </td>
                                                <td class="employee flex items-center px-10px flex-shrink-0 w-1/6">
                                                ...
                                                <td
                                                    ...
                                                    <div class="grid grid-rows-2 grid-flow-col gap-10px"><button
                                                            ...
                                                            id="showFieldOps-CHACAR"><svg class="svg-inline--fa fa-trash"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                                            ...
                                                            id="showSample-CHACAR"><svg class="svg-inline--fa fa-user"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                            ...
                                            <tr class="flex odd:bg-sky-100 odd:bg-opacity-50 py-15px px-10px">
                                                <td class="employee flex items-center px-10px py-20px flex-shrink-0 w-1/12">
                                                    <div
                                                        class="profile-img w-full h-auto mr-10px flex justify-center items-center">
                                                        <img w-full=""
                                                            src="https://kiliassets.speetra.com/prod/account_images/15407/campaign/1DE1BA473C7B1/1718740314_original.png"
                                                            alt="">
                                                    </div>
                                                </td>
                                                <td class="employee flex items-center px-10px flex-shrink-0 w-1/6">
                                                ...
                                                <td
                                                    ...
                                                    <div class="grid grid-rows-2 grid-flow-col gap-10px"><button
                                                            ...
                                                            id="showFieldOps-DAVSMI"><svg class="svg-inline--fa fa-trash"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                                            ...
                                                            id="showSample-DAVSMI"><svg class="svg-inline--fa fa-user"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                            ...
                                            <tr class="flex odd:bg-sky-100 odd:bg-opacity-50 py-15px px-10px">
                                                <td class="employee flex items-center px-10px py-20px flex-shrink-0 w-1/12">
                                                    <div
                                                        class="profile-img w-full h-auto mr-10px flex justify-center items-center">
                                                        <img w-full=""
                                                            src="https://kiliassets.speetra.com/prod/account_images/15407/campaign/1D5FD968043A1/1717791207_original.jpg"
                                                            alt="">
                                                    </div>
                                                </td>
                                                <td class="employee flex items-center px-10px flex-shrink-0 w-1/6">
                                                ...
                                                <td
                                                    ...
                                                    <div class="grid grid-rows-2 grid-flow-col gap-10px"><button
                                                            ...
                                                            id="showFieldOps-DERKIJ"><svg class="svg-inline--fa fa-trash"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                                            ...
                                                            id="showSample-DERKIJ"><svg class="svg-inline--fa fa-user"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                            ...
                                            <tr class="flex odd:bg-sky-100 odd:bg-opacity-50 py-15px px-10px">
                                                <td class="employee flex items-center px-10px py-20px flex-shrink-0 w-1/12">
                                                    <div
                                                        class="profile-img w-full h-auto mr-10px flex justify-center items-center">
                                                        <img w-full=""
                                                            src="https://kiliassets.speetra.com/prod/account_images/15407/campaign/1B8877CC03CD1/1713973037_original.jpg"
                                                            alt="">
                                                    </div>
                                                </td>
                                                <td class="employee flex items-center px-10px flex-shrink-0 w-1/6">
                                                ...
                                                <td
                                                    ...
                                                    <div class="grid grid-rows-2 grid-flow-col gap-10px"><button
                                                            ...
                                                            id="showFieldOps-GEOMCP"><svg class="svg-inline--fa fa-trash"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                                            ...
                                                            id="showSample-GEOMCP"><svg class="svg-inline--fa fa-user"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                            ...
                                            <tr class="flex odd:bg-sky-100 odd:bg-opacity-50 py-15px px-10px">
                                                <td class="employee flex items-center px-10px py-20px flex-shrink-0 w-1/12">
                                                    <div
                                                        class="profile-img w-full h-auto mr-10px flex justify-center items-center">
                                                        <img w-full=""
                                                            src="https://kiliassets.speetra.com/prod/account_images/15407/campaign/1DAE0B68A7A69/1718124834_original.png"
                                                            alt="">
                                                    </div>
                                                </td>
                                                <td class="employee flex items-center px-10px flex-shrink-0 w-1/6">
                                                ...
                                                <td
                                                    ...
                                                    <div class="grid grid-rows-2 grid-flow-col gap-10px"><button
                                                            ...
                                                            id="showFieldOps-GREBAR"><svg class="svg-inline--fa fa-trash"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                                            ...
                                                            id="showSample-GREBAR"><svg class="svg-inline--fa fa-user"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                            ...
                                            <tr class="flex odd:bg-sky-100 odd:bg-opacity-50 py-15px px-10px !bg-gray-300">
                                                <td class="employee flex items-center px-10px py-20px flex-shrink-0 w-1/12">
                                                    <div
                                                        class="profile-img w-full h-auto mr-10px flex justify-center items-center">
                                                        <img w-full=""
                                                            src="https://kiliassets.speetra.com/prod/account_images/15407/logo/1709862934_original.png"
                                                            alt="">
                                                    </div>
                                                </td>
                                                <td class="employee flex items-center px-10px flex-shrink-0 w-1/6">
                                                ...
                                                <td
                                                    ...
                                                    <div class="grid grid-rows-2 grid-flow-col gap-10px"><button
                                                            ...
                                                            class="btn btn-blue w-full rounded-2px" id="showFieldOps-null"><svg
                                                                class="svg-inline--fa fa-mobile-screen-button"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="mobile-screen-button" role="img"
                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                                                            ...
                                                            </svg> FieldOps App </button><!----><button
                                                            class="btn btn-blue rounded-2px" id="showSample-null"><svg
                                                                class="svg-inline--fa fa-user" aria-hidden="true"
                                            ...
                                            <tr class="flex odd:bg-sky-100 odd:bg-opacity-50 py-15px px-10px">
                                                <td class="employee flex items-center px-10px py-20px flex-shrink-0 w-1/12">
                                                    <div
                                                        class="profile-img w-full h-auto mr-10px flex justify-center items-center">
                                                        <img w-full=""
                                                            src="https://kiliassets.speetra.com/prod/account_images/15407/campaign/1E3CDD0C4EA59/1720630025_original.png"
                                                            alt="">
                                                    </div>
                                                </td>
                                                <td class="employee flex items-center px-10px flex-shrink-0 w-1/6">
                                                ...
                                                <td
                                                    ...
                                                    <div class="grid grid-rows-2 grid-flow-col gap-10px"><button
                                                            ...
                                                            id="showFieldOps-JESSMI"><svg class="svg-inline--fa fa-trash"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                                            ...
                                                            id="showSample-JESSMI"><svg class="svg-inline--fa fa-user"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                            ...
                                            <tr class="flex odd:bg-sky-100 odd:bg-opacity-50 py-15px px-10px">
                                                <td class="employee flex items-center px-10px py-20px flex-shrink-0 w-1/12">
                                                    <div
                                                        class="profile-img w-full h-auto mr-10px flex justify-center items-center">
                                                        <img w-full=""
                                                            src="https://kiliassets.speetra.com/prod/account_images/15407/campaign/1DD593824B201/1718547772_original.png"
                                                            alt="">
                                                    </div>
                                                </td>
                                                <td class="employee flex items-center px-10px flex-shrink-0 w-1/6">
                                                ...
                                                <td
                                                    ...
                                                    <div class="grid grid-rows-2 grid-flow-col gap-10px"><button
                                                            ...
                                                            id="showFieldOps-JOHJOR"><svg class="svg-inline--fa fa-trash"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                                            ...
                                                            id="showSample-JOHJOR"><svg class="svg-inline--fa fa-user"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                            ...
                                            <tr class="flex odd:bg-sky-100 odd:bg-opacity-50 py-15px px-10px">
                                                <td class="employee flex items-center px-10px py-20px flex-shrink-0 w-1/12">
                                                    <div
                                                        class="profile-img w-full h-auto mr-10px flex justify-center items-center">
                                                        <img w-full=""
                                                            src="https://kiliassets.speetra.com/prod/account_images/15407/campaign/1D430C7AA39C9/1716232747_original.png"
                                                            alt="">
                                                    </div>
                                                </td>
                                                <td class="employee flex items-center px-10px flex-shrink-0 w-1/6">
                                                ...
                                                <td
                                                    ...
                                                    <div class="grid grid-rows-2 grid-flow-col gap-10px"><button
                                                            ...
                                                            id="showFieldOps-KIEHUT"><svg class="svg-inline--fa fa-trash"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                                            ...
                                                            id="showSample-KIEHUT"><svg class="svg-inline--fa fa-user"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                            ...
                                            <tr class="flex odd:bg-sky-100 odd:bg-opacity-50 py-15px px-10px">
                                                <td class="employee flex items-center px-10px py-20px flex-shrink-0 w-1/12">
                                                    <div
                                                        class="profile-img w-full h-auto mr-10px flex justify-center items-center">
                                                        <img w-full=""
                                                            src="https://kiliassets.speetra.com/prod/account_images/15407/campaign/1C13D0A51CB21/1711652566_original.jpg"
                                                            alt="">
                                                    </div>
                                                </td>
                                                <td class="employee flex items-center px-10px flex-shrink-0 w-1/6">
                                                ...
                                                <td
                                                    ...
                                                    <div class="grid grid-rows-2 grid-flow-col gap-10px"><button
                                                            ...
                                                            id="showFieldOps-PAUHOA"><svg class="svg-inline--fa fa-trash"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                                            ...
                                                            id="showSample-PAUHOA"><svg class="svg-inline--fa fa-user"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                            ...
                                            <tr class="flex odd:bg-sky-100 odd:bg-opacity-50 py-15px px-10px">
                                                <td class="employee flex items-center px-10px py-20px flex-shrink-0 w-1/12">
                                                    <div
                                                        class="profile-img w-full h-auto mr-10px flex justify-center items-center">
                                                        <img w-full=""
                                                            src="https://kiliassets.speetra.com/prod/account_images/15407/campaign/1D8A897F9D3F9/1717590783_original.jpg"
                                                            alt="">
                                                    </div>
                                                </td>
                                                <td class="employee flex items-center px-10px flex-shrink-0 w-1/6">
                                                ...
                                                <td
                                                    ...
                                                    <div class="grid grid-rows-2 grid-flow-col gap-10px"><button
                                                            ...
                                                            id="showFieldOps-SCONEU"><svg class="svg-inline--fa fa-trash"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"
                                                            ...
                                                            id="showSample-SCONEU"><svg class="svg-inline--fa fa-user"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <path class="" fill="currentColor"

    ...
    <div data-v-dc04488c="" class="rounded-4px bg-white flex flex-col p-15px">
        ...
        <div data-v-dc04488c="" class="installation w-full flex">
            ...
            <div data-v-dc04488c="" class="w-1/2 p-10px">
                ...
                <p data-v-dc04488c="" class="py-10px"> If you have a wordpress site, we recommend this installation. Download and install our plugin using their instructions manual. In order for this to work, please make sure you have given us the correct <a data-v-dc04488c="" href="https://app.pulsem.me/settings/?tab=branding#napw">link to your page</a>. </p><button data-v-dc04488c="" class="btn btn-blue w-auto"> Wordpress Instructions </button>
            </div>
        </div>
        <div data-v-dc04488c="" class="widgets w-full flex">
            ...
            <div data-v-dc04488c="" class="w-1/3 p-10px">
                ...
                <p data-v-dc04488c="" class="py-10px"> A floating button for your website, lead generator, game changer. Your dot will give anyone visiting your website quick access to the best reviews you've gotten, your social media, and most importantly, a way to contact you without even closing the dot. </p><button data-v-dc04488c="" class="btn btn-blue w-auto"><svg data-v-dc04488c="" class="svg-inline--fa fa-arrow-up-right-from-square" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="arrow-up-right-from-square" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">

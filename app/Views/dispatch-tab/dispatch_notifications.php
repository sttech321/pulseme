      ...
      <div data-v-e3e752fc="" class="page grid grid-cols-2 <lg:grid-cols-1 gap-10px">
          <div data-v-e3e752fc="" class="flex flex-col justify-start items-stretch bg-white shadow rounded-4px w-full p-30px">
              <div class="row flex justify-between items-center mb-20px">
                  <h2 class="text-2xl font-light">Positive Feedback</h2><svg class="svg-inline--fa fa-face-smile text-4xl text-lime-400" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="face-smile" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              <div class="row mb-20px input-group flex-grow">
                  ...
                  <div class="input flex justify-between items-center">
                      ...
                      <div class="grid grid-cols-1 gap-10px"><button class="btn btn-red"><svg class="svg-inline--fa fa-trash" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                              ...
                              </svg> Delete Email</button><!----></div>
                  </div>
              </div>
          </div>
          <div data-v-e3e752fc="" class="flex flex-col justify-start items-stretch bg-white shadow rounded-4px w-full p-30px">
              <div class="flex justify-between items-center mb-20px">
                  <h2 class="text-2xl font-light">Neutral Feedback</h2><svg class="svg-inline--fa fa-face-meh text-4xl text-cyan-400" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="face-meh" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              <div class="mb-20px input-group">
                  ...
                  <div class="input flex justify-between items-center">
                      <p>caitlyn.seidel@halesac.com</p>
                      <div class="grid grid-cols-1 gap-10px"><button class="btn btn-red" id="delete-email-button"><svg class="svg-inline--fa fa-trash" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                  <path class="" fill="currentColor" d="M135.2 17.7L128 32H32C14.3 32 0 46.3 0 64S14.3 96 32 96H416c17.7 0 32-14.3 32-32s-14.3-32-32-32H320l-7.2-14.3C307.4 6.8 296.3 0 284.2 0H163.8c-12.1 0-23.2 6.8-28.6 17.7zM416 128H32L53.2 467c1.6 25.3 22.6 45 47.9 45H346.9c25.3 0 46.3-19.7 47.9-45L416 128z"></path>
                              </svg> Delete Email </button><!----></div>
                  </div>
              </div><!---->
          ...
          <div data-v-e3e752fc="" class="flex flex-col justify-start items-stretch bg-white shadow rounded-4px w-full p-30px">
              <div class="flex justify-between items-center mb-20px">
                  <h2 class="text-2xl font-light">Negative Feedback</h2><svg class="svg-inline--fa fa-face-frown text-4xl text-red-500" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="face-frown" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              <div class="mb-20px input-group">
                  ...
                  <div class="input flex justify-between items-center">
                      <p>caitlyn.seidel@halesac.com</p>
                      <div class="grid grid-cols-1 gap-10px"><button id="delete-email-button-0" class="btn btn-red"><svg class="svg-inline--fa fa-trash" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                  <path class="" fill="currentColor" d="M135.2 17.7L128 32H32C14.3 32 0 46.3 0 64S14.3 96 32 96H416c17.7 0 32-14.3 32-32s-14.3-32-32-32H320l-7.2-14.3C307.4 6.8 296.3 0 284.2 0H163.8c-12.1 0-23.2 6.8-28.6 17.7zM416 128H32L53.2 467c1.6 25.3 22.6 45 47.9 45H346.9c25.3 0 46.3-19.7 47.9-45L416 128z"></path>
                              </svg> Delete Email </button><!----></div>
                  </div>
              </div><!---->

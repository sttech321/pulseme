                        ...
                        <table class="w-full"> -->
                            ...
                            <?php// foreach ($technicians as $technician): ?>
                                <!-- <tr class="flex p-20px odd:bg-sky-50" id="<?= $technician['ID'] ?>">
                                    <form method="post" action="<?= base_url('/operate/create/'.$technician['ID'])?>">
                                        ...
                                        <td class="recipient-info grid grid-cols-6 gap-5px flex-grow">
                                            <div class="input-group col-span-3 flex items-center">
                                                <input
                                                    ...
                                                    type="tel" name="customer_phone" id="phone-<?= $technician['ID'] ?>" placeholder="Phone Number">
                                            </div>
                                            <div class="input-group col-span-3 flex items-center">
                                                <input
                                                    class="w-full bg-transparent outline-none border-b-1 focus:border-blue-500 py-7px"
                                                    type="email" name="customer_email" id="email-<?= $technician['ID'] ?>" placeholder="Email">
                                            </div>
                                            <div class="input-group col-span-3 lg:col-span-2 flex items-center">
                                                <input
                                                    class="w-full bg-transparent outline-none border-b-1 focus:border-blue-500 py-7px"
                                                    type="text" name="customer_name" id="name-<?= $technician['ID'] ?>"
                                                    placeholder="Name (Optional)">
                                            </div>
                                            <div class="input-group col-span-3 lg:col-span-4 flex items-center">
                                                <div class="mr-10px flex justify-center items-center">
                                                </div>
                                                <input class="w-full bg-transparent outline-none border-b-1 focus:border-blue-500 py-7px" type="text" name="customer_address" id="address-<?= $technician['ID'] ?>" placeholder="Address (Optional)">
                                            </div>
                                        </td>

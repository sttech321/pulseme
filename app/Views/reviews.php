                        ...
                        <?php foreach ($fetchreview as $review) : ?>
                           ...
                           <tr data-v-f15ab7a3="" data-v-428084ba="" class="flex w-full">
                              ...
                              <td data-v-f15ab7a3="" class="p-10px w-200px">
                                 <div id="<?= $review['ID'] ?>" class="flex flex-col items-center justify-center h-full" data-id="<?= $review['ID'] ?>" data-approved="<?= $review['isApproved'] ?>" data-archive="<?= $review['isArchive'] ?>">

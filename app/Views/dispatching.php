                       ...
                       if (response.technicians.length > 0) {
                           $.each(response.technicians, function(index, technician) {
                               technicianList.append('<tr class="flex p-20px odd:bg-sky-50">' +
                                   ...
                                   '<div class="flex justify-start items-center py-5px col-span-6"><div class="flex justify-start items-center col-span-3 cursor-pointer"><svg class="svg-inline--fa fa-square mr-5px text-17px" aria-hidden="true" focusable="false" data-prefix="far" data-icon="square" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"> <path class="" fill="currentColor" d="M384 80c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16H384zM64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"></path> </svg> <p>Mark as test</p></div></div>' +
                                   '</div>' +
                                   '<div class="input-group col-span-3 lg:col-span-2 flex items-center">' +
